...
export const DOCUMENT_CATEGORIES: CategoryDef[] = [
  ...
  },
  {
    ...
    documents: [
      ...
      { id: 'material_contracts', name: 'Material & Vendor Contracts (incl. Software & Suppliers)', description: 'All material contracts, vendor/supplier agreements, and software subscriptions exceeding $5,000 per year.', type: 'required', workstreams: ['ws1', 'ws2', 'both', 'ma'] },
