...
export const DOCUMENT_CATEGORIES: CategoryDef[] = [
  ...
  },
  {
    ...
    documents: [
      ...
      { id: 'material_contracts', name: 'Material & Vendor Contracts', description: 'Upload the actual contract documents (PDFs) for all vendor, supplier, software, and service agreements exceeding $5,000/year. These are analyzed for legal terms, change-of-control risks, and M&A readiness. Vendor names and key terms will be automatically extracted into your Software & Vendors directory.', type: 'required', workstreams: ['ws1', 'ws2', 'both', 'ma'] },
