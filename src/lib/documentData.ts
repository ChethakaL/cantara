...
export const VALUATION_DOCS: DocumentDef[] = [
  {
    id: 'financials_ytd',
    name: 'P&L — Current Year to Date',
    description: 'Current fiscal year P&L in Excel (all GL codes visible). Required before any other analysis begins.',
    type: 'required',
    workstreams: ['ws1', 'ws2', 'both', 'ma'],
  },
  {
    id: 'financials_y1',
    name: 'P&L — Prior Year 1',
    description: 'Full prior fiscal year P&L in Excel format.',
    type: 'required',
    workstreams: ['ws1', 'ws2', 'both', 'ma'],
  },
  {
    id: 'financials_y2',
    name: 'P&L — Prior Year 2',
    description: 'Full prior year -2 P&L in Excel format.',
    type: 'required',
    workstreams: ['ws1', 'ws2', 'both', 'ma'],
  },
  {
    id: 'financials_y3',
    name: 'P&L — Prior Year 3',
    description: 'Full prior year -3 P&L in Excel format.',
    type: 'required',
    workstreams: ['ws1', 'ws2', 'both', 'ma'],
  },
  {
    id: 'trailing_12',
    name: 'Trailing 12-Month P&L',
    description: 'Trailing twelve months P&L, current fiscal year designation.',
    type: 'required',
    workstreams: ['ws1', 'ws2', 'both', 'ma'],
  },
]
