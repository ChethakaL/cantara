...
export const DOCUMENT_CATEGORIES: CategoryDef[] = [
  {
    ...
    icon: 'Scale',
    documents: [
      { id: 'articles_org', name: 'Articles of Organization / Incorporation', description: 'Company articles of organization or incorporation. Select No if the business has no formal formation documents on hand.', type: 'yes_no', workstreams: ['ws1', 'ws2', 'both', 'ma'], parentOnly: true },
      ...
      { id: 'good_standing_certificate', name: 'Good Standing Certificate', description: 'Certificate of good standing or certificate of existence from the state of formation.', type: 'yes_no', workstreams: ['ws1', 'ws2', 'both', 'ma'], parentOnly: true },
