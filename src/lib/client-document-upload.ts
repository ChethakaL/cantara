...
const DOCUMENT_UPLOAD_RULES: Record<string, UploadRuleKind> = {
  ...
  operating_agreement_bylaws: 'pdf_or_image',
  org_document_amendments: 'pdf_or_image',
  good_standing_certificate: 'pdf_or_image',
  annual_reports: 'pdf_or_image',
  ownership_structure: 'pdf_or_image',
  business_licenses: 'pdf_or_image',
  kennel_license: 'pdf_or_image',
  health_permit: 'pdf_or_image',
  fire_permit: 'pdf_or_image',
  zoning_approval: 'pdf_or_image',
  certificate_occupancy: 'pdf_or_image',
  conditional_use_permit: 'pdf_or_image',
  signage_permit: 'pdf_or_image',
  building_permits: 'pdf_or_image',
  environmental_permits: 'pdf_or_image',
  variance_approvals: 'pdf_or_image',
