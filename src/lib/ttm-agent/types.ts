...
export const WS2_RECAST_EXTRA_OPTIONAL_DOCUMENT_IDS = ["leases", "quickbooks_api", "owner_gm_assessment", "valuation_context"] as const;
...
export type TtmOptionalDocumentId = "quickbooks_api" | "valuation_context";
