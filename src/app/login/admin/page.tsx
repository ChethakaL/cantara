      ...
      <div className="w-full max-w-sm px-6">
        ...
        <div className="rounded-2xl p-8" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(241,230,187,0.08)' }}>
          ...
          <div className="relative mb-8">
            <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-cantara-sun/5"></div></div>
            <div className="relative flex justify-center text-[10px] uppercase tracking-widest"><span className="px-2 text-cantara-sun/30" style={{ background: '#21263C' }}>or continue with</span></div>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-cantara-sun/5">
            <p className="text-cantara-sun/25 text-xs text-center leading-relaxed">
