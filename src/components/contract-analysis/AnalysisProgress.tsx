    ...
    <div className="space-y-4 py-8">
      ...
      <div className="space-y-1 text-center">
        <p className="text-sm font-medium text-slate-600">
          {status === 'uploading' ? 'Preparing documents...' : 'AI is analyzing your contracts...'}
        </p>
      ...
      <p className="text-xs text-slate-400 italic text-center">This usually takes 60-90 seconds for a full contract package.</p>
    </div>
  )
}
