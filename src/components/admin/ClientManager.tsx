...
const SYSTEM_WORKSTREAM_AGENTS: Record<Exclude<Workstream, null>, AgentDocumentSelection[]> = {
  ...
  ws2: [
    ...
    { agentId: 'facility_review', agentName: 'Facility Review Agent', documentIds: [] },
    { agentId: 'occupancy_review', agentName: 'Occupancy Review Agent', documentIds: [] },
    { agentId: 'pricing_analysis', agentName: 'Competitive Pricing Analysis Agent', documentIds: [] },
    { agentId: 'pricing_vertical', agentName: 'Pricing by Vertical Agent', documentIds: [] },
    { agentId: 'sales_process_review', agentName: 'Sales Process Review Agent', documentIds: [] },
  ],
  ma: [
    { agentId: 'ttm', agentName: 'Valuation Agent', documentIds: [] },
