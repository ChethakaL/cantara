...
const AGENT_CATALOG = [
  ...
  { id: 'legal_entity_search', name: 'Legal Reports & Entity Search Agent', defaultDocumentIds: ['articles_org', 'org_document_amendments', 'annual_reports', 'good_standing_certificate', 'shareholder_agreement', 'ownership_structure', 'business_licenses'] },
  ...
  { id: 'tax_liability_review', name: 'Tax Liability Review Agent', defaultDocumentIds: ['tax_returns_3yr', 'irs_941_940_3yr', 'state_unemployment_filings', 'contractor_1099_agreements', 'sales_use_tax_3yr', 'irs_tax_notices_3yr'] },
