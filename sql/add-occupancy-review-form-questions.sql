...
VALUES
  ('occupancy_review_totalDailyCapacity', 'occupancy_review', 'Occupancy Review Agent', 'occupancyTotalDailyCapacity', 'Total daily capacity (dogs)', 'Owner-stated maximum daily capacity across boarding and daycare combined.', 'number', '75', true, NULL, 'occupancy_capacity', 'Capacity Model', 400, true),
  ('occupancy_review_boardingRuns', 'occupancy_review', 'Occupancy Review Agent', 'occupancyBoardingRuns', 'Total boarding runs / kennels', 'Number of boarding runs or suites at full capacity.', 'number', '45', true, NULL, 'occupancy_capacity', 'Capacity Model', 410, true),
