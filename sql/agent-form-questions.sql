...
VALUES
  ...
  ('competitor_analysis_competitor2Name', 'competitor_analysis', 'Competitor Analysis Agent', 'competitor2Name', 'Competitor 2 name', NULL, 'text', 'Competitor name', true, NULL, 'competitors', 'Competitor Inputs', 144, true),
  ('competitor_analysis_competitor2Website', 'competitor_analysis', 'Competitor Analysis Agent', 'competitor2Website', 'Competitor 2 website', NULL, 'url', 'https://competitor.com', true, NULL, 'competitors', 'Competitor Inputs', 145, true),
  ('competitor_analysis_competitor3Name', 'competitor_analysis', 'Competitor Analysis Agent', 'competitor3Name', 'Competitor 3 name', NULL, 'text', 'Competitor name', true, NULL, 'competitors', 'Competitor Inputs', 146, true),
  ('competitor_analysis_competitor3Website', 'competitor_analysis', 'Competitor Analysis Agent', 'competitor3Website', 'Competitor 3 website', NULL, 'url', 'https://competitor.com', true, NULL, 'competitors', 'Competitor Inputs', 147, true),
  ('competitor_analysis_competitor4Name', 'competitor_analysis', 'Competitor Analysis Agent', 'competitor4Name', 'Competitor 4 name', NULL, 'text', 'Competitor name', true, NULL, 'competitors', 'Competitor Inputs', 148, true),
  ('competitor_analysis_competitor4Website', 'competitor_analysis', 'Competitor Analysis Agent', 'competitor4Website', 'Competitor 4 website', NULL, 'url', 'https://competitor.com', true, NULL, 'competitors', 'Competitor Inputs', 149, true),
  ('competitor_analysis_competitor5Name', 'competitor_analysis', 'Competitor Analysis Agent', 'competitor5Name', 'Competitor 5 name', NULL, 'text', 'Competitor name', true, NULL, 'competitors', 'Competitor Inputs', 150, true),
  ('competitor_analysis_competitor5Website', 'competitor_analysis', 'Competitor Analysis Agent', 'competitor5Website', 'Competitor 5 website', NULL, 'url', 'https://competitor.com', true, NULL, 'competitors', 'Competitor Inputs', 151, true),
  ...
  ('pricing_analysis_competitor2Name', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor2Name', 'Competitor 2 name', NULL, 'text', 'Competitor name', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 502, true),
  ('pricing_analysis_competitor2Website', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor2Website', 'Competitor 2 website', NULL, 'url', 'https://competitor.com/pricing', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 503, true),
  ('pricing_analysis_competitor3Name', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor3Name', 'Competitor 3 name', NULL, 'text', 'Competitor name', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 504, true),
  ('pricing_analysis_competitor3Website', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor3Website', 'Competitor 3 website', NULL, 'url', 'https://competitor.com/pricing', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 505, true),
  ('pricing_analysis_competitor4Name', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor4Name', 'Competitor 4 name', NULL, 'text', 'Competitor name', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 506, true),
  ('pricing_analysis_competitor4Website', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor4Website', 'Competitor 4 website', NULL, 'url', 'https://competitor.com/pricing', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 507, true),
  ('pricing_analysis_competitor5Name', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor5Name', 'Competitor 5 name', NULL, 'text', 'Competitor name', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 508, true),
  ('pricing_analysis_competitor5Website', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor5Website', 'Competitor 5 website', NULL, 'url', 'https://competitor.com/pricing', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 509, true)
