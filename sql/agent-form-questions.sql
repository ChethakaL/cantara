...
VALUES
  ...
  ('pricing_analysis_competitor1Name', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor1Name', 'Competitor 1 name', NULL, 'text', 'Competitor name', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 201, true),
  ('pricing_analysis_competitor1Website', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor1Website', 'Competitor 1 website', NULL, 'url', 'https://competitor.com/pricing', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 202, true),
  ('pricing_analysis_competitor2Name', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor2Name', 'Competitor 2 name', NULL, 'text', 'Competitor name', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 203, true),
  ('pricing_analysis_competitor2Website', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor2Website', 'Competitor 2 website', NULL, 'url', 'https://competitor.com/pricing', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 204, true),
  ('pricing_analysis_competitor3Name', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor3Name', 'Competitor 3 name', NULL, 'text', 'Competitor name', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 205, true),
  ('pricing_analysis_competitor3Website', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor3Website', 'Competitor 3 website', NULL, 'url', 'https://competitor.com/pricing', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 206, true),
  ('pricing_analysis_competitor4Name', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor4Name', 'Competitor 4 name', NULL, 'text', 'Competitor name', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 207, true),
  ('pricing_analysis_competitor4Website', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor4Website', 'Competitor 4 website', NULL, 'url', 'https://competitor.com/pricing', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 208, true),
  ('pricing_analysis_competitor5Name', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor5Name', 'Competitor 5 name', NULL, 'text', 'Competitor name', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 209, true),
  ('pricing_analysis_competitor5Website', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'competitor5Website', 'Competitor 5 website', NULL, 'url', 'https://competitor.com/pricing', true, NULL, 'pricing_competitors', 'Competitor Pricing Inputs', 210, true)
