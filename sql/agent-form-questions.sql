...
VALUES
  ...
  -- businessWebsite deactivated for competitor_analysis & pricing_analysis: entered once under Digital Presence, propagated on the backend
  ('competitor_analysis_businessWebsite', 'competitor_analysis', 'Competitor Analysis Agent', 'businessWebsite', 'Business website', 'Main business website or most relevant service/pricing page.', 'url', 'https://yourbusiness.com', true, NULL, 'business', 'Business Information', 10, false),
  ('pricing_analysis_businessWebsite', 'pricing_analysis', 'Competitive Pricing Analysis Agent', 'businessWebsite', 'Business website', 'Main business website or most relevant service/pricing page.', 'url', 'https://yourbusiness.com/pricing', true, NULL, 'business', 'Business Information', 10, false),
